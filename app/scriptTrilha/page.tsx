...
const MainContent = ({ contentTracks, openTracks, toggleTrack }) => (
  <main className="flex-grow flex justify-between items-start p-6 bg-white">
    {/* Nova div com texto e progresso, posicionada à esquerda e responsiva */}
    ...
    {/* Menu de trilhas com largura ajustada para ser um pouco menor */}
